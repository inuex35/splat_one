...
RUN apt install wget ffmpeg -y && mkdir -p /root/.cache/torch/hub/checkpoints && wget https://download.pytorch.org/models/alexnet-owt-7be5be79.pth -O /root/.cache/torch/hub/checkpoints/alexnet-owt-7be5be79.pth && pip3 install mapillary_tools
