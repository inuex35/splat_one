...
import viser
import yaml
from utils.datasets.opensfm import Dataset, Parser
from utils.datasets.traj import (
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if not cfg.disable_viewer:
                ...
                self.viewer.update(step, num_train_rays_per_sec)
    ...
    if cfg.compression == "png":
        try:
            ...
            raise ImportError(
                ...
                "torchpq (see https://github.com/DeMoriarty/TorchPQ) "
